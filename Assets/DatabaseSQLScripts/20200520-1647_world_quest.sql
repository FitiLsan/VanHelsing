...
update 'quest_objectives' SET Type='8', TargetId='37', Amount='1',isOptional ='0' where QuestId='5' and Id ='7'; 
update 'quest_objectives_locale_ru' SET Title='Отдать лекарство NPC 2' where ObjectiveId = '7'; 
update 'quest_objectives' SET Type='8', TargetId='39', Amount='1',isOptional ='0' where QuestId='5' and Id ='8'; 
update 'quest_objectives_locale_ru' SET Title='Отдать лекарство NPC 3' where ObjectiveId = '8'; 
update 'quest_objectives' SET Type='8', TargetId='42', Amount='1',isOptional ='0' where QuestId='5' and Id ='9'; 
update 'quest_objectives_locale_ru' SET Title='������' where ObjectiveId = '9'; 
