    ...
    internal class MovementController : BaseController
    {
        ...
        private void JumpAndGravity()
        {
            ...
            if (IsGrounded && StartScript.GetStartScript.StaminaController.CanJump)
                _charController.Rigidbody.AddForce(Vector3.up * _charController.charJumpForce, ForceMode.VelocityChange);
            //else
        ...
        private void Roll()
        {
            ...
            Debug.Log("Rolling");
            _charController.Rigidbody.AddForce(_player.forward * _charController.charRollSpeed, ForceMode.Impulse);
            _charController.Rigidbody.AddForce(Vector3.down * _charController.charFallForce,
                ForceMode.VelocityChange);
        }
