...
namespace BeastHunter
{
    ...
    public class ThrowAttackSkill : BossBaseSkill
    {
        ...
        public ThrowAttackSkill((int, float, float, float, bool, bool) skillInfo, Dictionary<int, BossBaseSkill> skillDictionary, BossStateMachine stateMachine) : base(skillInfo, skillDictionary, stateMachine)
        {
        }
