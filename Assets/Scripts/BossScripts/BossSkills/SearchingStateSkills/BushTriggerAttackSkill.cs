...
namespace BeastHunter
{
    ...
    public class BushTriggerAttackSkill : BossBaseSkill
    {
        ...
        public BushTriggerAttackSkill((int, float, float, float, bool, bool) skillInfo, Dictionary<int, BossBaseSkill> skillDictionary, BossStateMachine stateMachine) : base(skillInfo, skillDictionary, stateMachine)
        {
        }
