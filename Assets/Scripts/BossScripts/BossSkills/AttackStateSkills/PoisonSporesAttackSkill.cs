...
namespace BeastHunter
{
    ...
    public class PoisonSporesAttackSkill : BossBaseSkill
    {
        ...
        public PoisonSporesAttackSkill((bool, int, float, float, float, bool, bool) skillInfo, Dictionary<int, BossBaseSkill> skillDictionary, BossStateMachine stateMachine) : base(skillInfo, skillDictionary, stateMachine)
        {
        }
