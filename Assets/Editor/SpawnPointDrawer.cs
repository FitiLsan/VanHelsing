...
namespace BeastHunter
{
    ...
    //        property.isExpanded = EditorGUI.Foldout(new Rect(position.x + 5, position.y, 10, EditorGUIUtility.singleLineHeight), property.isExpanded, property.displayName);
    //        //property.isExpanded = EditorGUI.BeginFoldoutHeaderGroup(new Rect(position.x + 5, position.y, position.width - 10, position.height), property.isExpanded, property.displayName);
    ...
    //        {
    //            var radiusRect = new Rect(position.x, position.y + EditorGUIUtility.singleLineHeight, position.width, EditorGUIUtility.singleLineHeight);
    //            _radius.floatValue = EditorGUI.FloatField(radiusRect, new GUIContent("Radius:", "Radius of spawn"), _radius.floatValue);
    //        }
            
    //        //var numberRect = new Rect(position.x + 35, position.y, 50, position.height);
    //        //_number.intValue = EditorGUI.IntSlider(numberRect, new GUIContent("Amount:", "Number of entities to spawn"), _number.intValue, 1, MAX_ENTITIES_TO_SPAWN);
    ...
    //        //_spawnList = property.FindPropertyRelative("_spawnDataList");
